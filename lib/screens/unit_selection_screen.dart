        ...
        if (widget.grade == 12) {
          return [
            ...
            },
            {
              ...
              'enDesc': 'Antiderivatives, indefinite and definite integrals, substitution, integration by parts, and area under curves.',
              'amDesc': 'ፀረ-ተዋጽኦዎች፣ የተወሰኑ እና ያልተወሰኑ ኢንቴግራሎች፣ የቅያሬ ዘዴ፣ በክፍል ማዋሃድ እና የቦታ ስፋት።',
            },
            {
              'id': 'math_u4',
              'grade': 12,
            ...
            },
            {
              ...
              'enUnit': 'Unit 5: Statistics and Probability',
              'amUnit': 'ክፍል 5: ስታቲስቲክስ እና ፕሮባብሊቲ',
              'enDesc': 'Probability distributions, expected value, binomial distributions, normal distribution, and inferential statistics.',
              'amDesc': 'የፕሮባብሊቲ ስርጭት፣ የሚጠበቅ እሴት፣ ባይኖሚያል እና ኖርማል ስርጭቶች፣ እና ኢንፈረንሻል ስታቲስቲክስ።',
            },
          ];
        }
        return [
          ...
          return [
            {
              ...
              'enUnit': 'Unit 1: Biotechnology',
              'amUnit': 'ክፍል 1: ባዮቴክኖሎጂ',
              'enDesc': 'Recombinant DNA technology, cloning, GMOs, PCR, applications in medicine and agriculture.',
              'amDesc': 'ዳግም የተዋሃደ የዲኤንኤ ቴክኖሎጂ፣ ክሎኒንግ፣ ጂኤምኦ፣ ፒሲአር፣ እና በህክምናና ግብርና ላይ ያሉ አተገባበሮች።',
            },
            {
              'id': 'bio_u2',
              'grade': 12,
              'enUnit': 'Unit 2: Evolution',
              'amUnit': 'ክፍል 2: ዝግመተ ለውጥ',
              'enDesc': 'Theories of evolution, natural selection, evidence of evolution, speciation, and human ancestry.',
              'amDesc': 'የዝግመተ ለውጥ ንድፈ ሃሳቦች፣ ተፈጥሯዊ ምርጫ፣ የዝግመተ ለውጥ ማስረጃዎች፣ ዝርያ መፈጠር እና የሰው አመጣጥ።',
            },
            {
              'id': 'bio_u3',
              'grade': 12,
              'enUnit': 'Unit 3: Genetics',
              'amUnit': 'ክፍል 3: ጄኔቲክስ',
              'enDesc': 'Molecular genetics, gene expression, mutations, chromosomal inheritance patterns, and genetic engineering.',
              'amDesc': 'ሞለኪውላር ጄኔቲክስ፣ የጂን አገላለጽ፣ ሚውቴሽን፣ የክሮሞሶም ውርስ ንድፎች እና የዘረመል ምህንድስና።',
            },
            {
              'id': 'bio_u4',
              'grade': 12,
              'enUnit': 'Unit 4: Human Biology',
              'amUnit': 'ክፍል 4: የሰው ባዮሎጂ',
              'enDesc': 'Human organ systems, homeostasis, nervous and endocrine control, immunology, and reproductive biology.',
              'amDesc': 'የሰው አካል ስርዓቶች፣ ሆሚዮስታሲስ፣ የነርቭ እና ሆርሞን ቁጥጥር፣ ስነ-በሽታ መከላከል እና የስነ-ተዋልዶ ባዮሎጂ።',
            },
            {
              'id': 'bio_u5',
              'grade': 12,
              'enUnit': 'Unit 5: Ecology',
              'amUnit': 'ክፍል 5: ሥነ-ምህዳር',
              'enDesc': 'Population dynamics, community ecology, trophic levels, energy flow, and biogeochemical cycles.',
              'amDesc': 'የህዝብ ብዛት ተለዋዋጭነት፣ የማህበረሰብ ስነ-ምህዳር፣ የምግብ ሰንሰለት ደረጃዎች፣ የሃይል ፍሰት እና ኬሚካላዊ ዑደቶች።',
            },
            {
              'id': 'bio_u6',
              'grade': 12,
              'enUnit': 'Unit 6: Conservation Biology',
              'amUnit': 'ክፍል 6: የጥበቃ ባዮሎጂ',
              'enDesc': 'Biodiversity threats, endangered species, protected areas, ecosystem restoration, and sustainable management.',
              'amDesc': 'የብዝሃ ህይወት ስጋቶች፣ የመጥፋት አደጋ የተጋረጠባቸው ዝርያዎች፣ የተከለሉ ቦታዎች እና ዘላቂ የተፈጥሮ ሀብት አስተዳደር።',
            },
          ];
        }
        return [
          ...
          return [
            {
              ...
              'enDesc': 'Magnetic flux, Faraday’s law, Lenz’s law, self and mutual induction, generators, and transformers.',
              'amDesc': 'ማግኔቲክ ፍለክስ፣ የፋራዳይ ህግ፣ የሌንዝ ህግ፣ ራስ እና የጋራ ኢንዳክሽን፣ ጄነሬተሮች እና ትራንስፎርመሮች።',
            },
            {
              'id': 'phys_u2',
              'grade': 12,
              ...
              'enDesc': 'Maxwell’s equations, electromagnetic spectrum, propagation of waves, reflection, refraction, and dispersion.',
              'amDesc': 'የማክስዌል እኩልታዎች፣ የኤሌክትሮማግኔቲክ ስፔክትረም፣ የሞገድ ስርጭት፣ ነጸብራቅ፣ ስብራት እና መበታተን።',
            },
            {
              'id': 'phys_u3',
              'grade': 12,
              ...
              'enDesc': 'Photoelectric effect, Bohr model of hydrogen atom, atomic spectra, X-rays, and dual nature of matter.',
              'amDesc': 'ፎቶኤሌክትሪክ ተፅእኖ፣ የቦህር ሃይድሮጂን አቶም ሞዴል፣ አቶሚክ ስፔክትራ፣ ኤክስ-ሬይ እና የማተር ባለ ሁለት ባህሪ።',
            },
            {
              'id': 'phys_u4',
              'grade': 12,
              ...
              'enDesc': 'Nuclear structure, binding energy, radioactivity, radioactive decay law, nuclear fission, fusion, and reactors.',
              'amDesc': 'የኒውክሊየስ መዋቅር፣ አስገዳጅ ሃይል፣ ራዲዮአክቲቪቲ፣ የኒውክሌር መበስበስ ህግ፣ ፊሽን፣ ፊውዥን እና ሪአክተሮች።',
            },
            {
              'id': 'phys_u5',
              'grade': 12,
              ...
              'enDesc': 'Semiconductors, p-n junction diodes, rectification, transistors, integrated circuits, and digital logic gates.',
              'amDesc': 'ሴሚኮንዳክተሮች፣ ፒ-ኤን ዳዮዶች፣ ሬክቲፊኬሽን፣ ትራንዚስተሮች፣ የተቀናጁ ሰርኪዩቶች እና ዲጂታል ሎጂክ ጌቶች።',
            },
          ];
        }
        return [
          ...
          return [
            {
              ...
              'enDesc': 'First and second laws of thermodynamics, enthalpy, entropy, Gibbs free energy, and reaction spontaneity.',
              'amDesc': 'የቴርሞዳይናሚክስ የመጀመሪያ እና ሁለተኛ ህጎች፣ ኤንታልፒ፣ ኢንትሮፒ፣ የጊብስ ነፃ ሃይል እና የምላሽ ድንገተኛነት።',
            },
            {
              'id': 'chem_u2',
              'grade': 12,
              ...
              'enDesc': 'Rate laws, order of reaction, reaction mechanisms, activation energy, Arrhenius equation, and catalysis.',
              'amDesc': 'የፍጥነት ህጎች፣ የምላሽ ቅደም ተከተል፣ የምላሽ ዘዴዎች፣ አክቲቬሽን ሃይል፣ የአሬኒየስ እኩልታ እና ካታላይሲስ።',
            },
            {
              'id': 'chem_u3',
              'grade': 12,
              ...
              'enDesc': 'Dynamic equilibrium, equilibrium constants Kc and Kp, Le Chatelier’s principle, and solubility equilibria.',
              'amDesc': 'ተለዋዋጭ ሚዛን፣ የሚዛን ቋሚዎች Kc እና Kp፣ የሌ ሻተሌየር መርህ እና የመሟሟት ሚዛን።',
            },
            {
              'id': 'chem_u4',
              'grade': 12,
              ...
              'enDesc': 'Redox reactions, galvanic cells, standard electrode potentials, Nernst equation, electrolytic cells, and batteries.',
              'amDesc': 'ሬዶክስ ምላሾች፣ የጋልቫኒክ ህዋሶች፣ መደበኛ ኤሌክትሮድ ፖቴንሻል፣ ኔርነስት እኩልታ፣ ኤሌክትሮላይቲክ ሴሎች እና ባትሪዎች።',
            },
            {
              'id': 'chem_u5',
              'grade': 12,
              ...
              'enDesc': 'Atmospheric chemistry, greenhouse effect, ozone depletion, water pollution, green chemistry principles, and waste management.',
              'amDesc': 'የከባቢ አየር ኬሚስትሪ፣ የግሪንሃውስ ተፅእኖ፣ የኦዞን መመናመን፣ የውሃ ብክለት፣ የአረንጓዴ ኬሚስትሪ መርሆዎች እና የቆሻሻ አያያዝ።',
            },
          ];
        }
        return [
          ...
          return [
            {
              'id': 'geo_u1',
              'grade': 12,
              'enUnit': 'Unit 1: Geomorphology',
              'amUnit': 'ክፍል 1: ጂኦሞርፎሎጂ',
              'enDesc': 'Internal and external landform processes, plate tectonics, vulcanicity, earthquakes, weathering, and fluvial landforms.',
              'amDesc': 'የመሬት ገጽታ ውስጣዊና ውጫዊ ሂደቶች፣ የፕሌት ቴክቶኒክስ፣ የእሳተ ገሞራ እንቅስቃሴ፣ የመሬት መንቀጥቀጥ እና የአፈር መሸርሸር።',
            },
            {
              'id': 'geo_u2',
              'grade': 12,
              'enUnit': 'Unit 2: Climatology',
              'amUnit': 'ክፍል 2: ክላይማቶሎጂ',
              'enDesc': 'Atmospheric layers, solar radiation, temperature patterns, global pressure belts, planetary wind systems, and air masses.',
              'amDesc': 'የከባቢ አየር ንብርብሮች፣ የፀሐይ ጨረር፣ የሙቀት ንድፎች፣ የአለም የአየር ግፊት ቀበቶዎች እና የንፋስ ስርዓቶች።',
            },
            {
              'id': 'geo_u3',
              'grade': 12,
              'enUnit': 'Unit 3: Biogeography',
              'amUnit': 'ክፍል 3: ባዮጂኦግራፊ',
              'enDesc': 'Biosphere components, soil formation and classification, global biomes distribution, biodiversity patterns, and ecosystems.',
              'amDesc': 'የባዮስፌር ክፍሎች፣ የአፈር አፈጣጠር እና ምደባ፣ የአለም አቀፍ ባዮሞች ስርጭት እና የስነ-ምህዳር ብዝሃነት።',
            },
            {
              'id': 'geo_u4',
              'grade': 12,
              'enUnit': 'Unit 4: Population Geography',
              'amUnit': 'ክፍል 4: የህዝብ ጂኦግራፊ',
              'enDesc': 'Global population dynamics, demographic transition model, population pyramids, spatial distribution, and international migration.',
              'amDesc': 'የአለም ህዝብ ቁጥር ተለዋዋጭነት፣ የዴሞግራፊክ ሽግግር ሞዴል፣ የህዝብ ፒራሚዶች እና አለም አቀፍ ፍልሰት።',
            },
            {
              'id': 'geo_u5',
              'grade': 12,
              'enUnit': 'Unit 5: Economic Geography',
              'amUnit': 'ክፍል 5: ኢኮኖሚክ ጂኦግራፊ',
              'enDesc': 'Primary, secondary, tertiary, and quaternary economic activities, location theories, resources distribution, and global markets.',
              'amDesc': 'ዋና ዋና የኢኮኖሚ እንቅስቃሴዎች፣ የአካባቢ መገኛ ንድፈ ሃሳቦች፣ የሀብቶች ስርጭት እና አለም አቀፍ ገበያዎች።',
            },
            {
              'id': 'geo_u6',
              'grade': 12,
              'enUnit': 'Unit 6: Environmental Geography',
              'amUnit': 'ክፍል 6: የአካባቢ ጂኦግራፊ',
              'enDesc': 'Human-environment interactions, environmental degradation, deforestation, desertification, global warming, and conservation.',
              'amDesc': 'የሰው እና አካባቢ መስተጋብር፣ የአካባቢ መራቆት፣ የደን መጨፍጨፍ፣ የበረሃማነት መስፋፋት እና የአየር ንብረት ለውጥ ጥበቃ።',
            },
            {
              'id': 'geo_u7',
              'grade': 12,
              'enUnit': 'Unit 7: Regional Geography',
              'amUnit': 'ክፍል 7: ሪጅናል ጂኦግራፊ',
              'enDesc': 'Concepts of region, regional planning, spatial development disparities, and major geographic regions of Africa and the world.',
              'amDesc': 'የቀጠና ጽንሰ-ሀሳብ፣ የቀጠና ልማት እቅድ፣ የቦታ ልማት ልዩነቶች እና የአፍሪካና የአለም ዋና ዋና ጂኦግራፊያዊ ቀጠናዎች።',
            },
            {
              'id': 'geo_u8',
              'grade': 12,
              'enUnit': 'Unit 8: Geographic Information Systems',
              'amUnit': 'ክፍል 8: የጂኦግራፊያዊ መረጃ ስርዓቶች (GIS)',
              'enDesc': 'GIS components, spatial and attribute data, raster and vector models, remote sensing fundamentals, GPS, and spatial analysis.',
              'amDesc': 'የጂአይኤስ ክፍሎች፣ የቦታ እና ባህሪ መረጃዎች፣ ራስተር እና ቬክተር ሞዴሎች፣ የርቀት ዳሰሳ (Remote Sensing) እና ጂፒኤስ።',
            },
          ];
        }
        return [
          ...
          return [
            {
              'id': 'hist_u1',
              'grade': 12,
              'enUnit': 'Unit 1: Ethiopia and the Horn of Africa, 1855–1913',
              'amUnit': 'ክፍል 1: ኢትዮጵያና የአፍሪካ ቀንድ፣ 1855–1913',
              'enDesc': 'State building under Tewodros II, Yohannes IV, Menelik II, modern administration, and the Battle of Adwa.',
              'amDesc': 'የሀገር ግንባታ በቴዎድሮስ 2ኛ፣ ዮሐንስ 4ኛ፣ ምኒልክ 2ኛ፣ ዘመናዊ አስተዳደር እና የአድዋ ድል ታሪክ።',
            },
            {
              'id': 'hist_u2',
              'grade': 12,
              'enUnit': 'Unit 2: Ethiopia and the Horn of Africa, 1913–1941',
              'amUnit': 'ክፍል 2: ኢትዮጵያና የአፍሪካ ቀንድ፣ 1913–1941',
              'enDesc': 'Lij Iyasu era, Empress Zewditu, rise of Ras Teferi/Haile Selassie I, Italian invasion and patriotic resistance.',
              'amDesc': 'የልጅ ኢያሱ ዘመን፣ ንግስት ዘውዲቱ፣ የራስ ተፈሪ/ኃይለ ሥላሴ መነሳት፣ የፋሺስት ጣሊያን ወረራ እና የአርበኞች ተጋድሎ።',
            },
            {
              'id': 'hist_u3',
              'grade': 12,
              'enUnit': 'Unit 3: Ethiopia from 1941–1974',
              'amUnit': 'ክፍል 3: ኢትዮጵያ ከ1941–1974',
              'enDesc': 'Post-war restoration, British influence, Eritrean federation and union, peasant rebellions, student movement, and socio-economic changes.',
              'amDesc': 'የድህረ-ጦርነት መልሶ ማቋቋም፣ የብሪታንያ ተፅእኖ፣ የኤርትራ ፌዴሬሽንና ውህደት፣ የገበሬዎች አመጽ፣ የተማሪዎች ንቅናቄ።',
            },
            {
              'id': 'hist_u4',
              'grade': 12,
              'enUnit': 'Unit 4: The Ethiopian Revolution and the Derg Regime',
              'amUnit': 'ክፍል 4: የኢትዮጵያ አብዮት እና የደርግ አገዛዝ',
              'enDesc': '1974 popular revolution, overthrow of monarchy, PMAC/Derg socialist policies, Red Terror, civil war, and downfall in 1991.',
              'amDesc': 'የ1974ቱ ህዝባዊ አብዮት፣ የንጉሳዊ ስርዓቱ መውደቅ፣ የደርግ የሶሻሊዝም ፖሊሲዎች፣ ቀይ ሽብር፣ የእርስ በርስ ጦርነት እና ውድቀት።',
            },
            {
              'id': 'hist_u5',
              'grade': 12,
              'enUnit': 'Unit 5: Ethiopia Since 1991',
              'amUnit': 'ክፍል 5: ኢትዮጵያ ከ1991 ጀምሮ',
              'enDesc': 'Transitional government, 1995 FDRE constitution, ethnic federalism, economic reforms, regional developments, and national transformation.',
              'amDesc': 'የሽግግር መንግስት፣ የ1987 የኢፌዴሪ ህገ-መንግስት፣ የብሄር ፌዴራሊዝም፣ የኢኮኖሚ ማሻሻያዎች እና ሀገራዊ ለውጦች።',
            },
            {
              'id': 'hist_u6',
              'grade': 12,
              'enUnit': 'Unit 6: Africa Since 1960',
              'amUnit': 'ክፍል 6: አፍሪካ ከ1960 ጀምሮ',
              'enDesc': 'Year of Africa, decolonization struggles, formation of OAU/AU, post-colonial governance challenges, and regional integration.',
              'amDesc': 'የአፍሪካ የነጻነት አመት፣ የቅኝ ግዛት ማክተም ትግሎች፣ የኦኤዩ/አፍሪካ ህብረት ምስረታ፣ የድህረ-ቅኝ ግዛት አስተዳደር ፈተናዎች።',
            },
            {
              'id': 'hist_u7',
              'grade': 12,
              'enUnit': 'Unit 7: International Relations and Globalization',
              'amUnit': 'ክፍል 7: አለም አቀፍ ግንኙነቶች እና ግሎባላይዜሽን',
              'enDesc': 'Cold War rivalry, Non-Aligned Movement, collapse of USSR, unipolar and multipolar world orders, and economic globalization.',
              'amDesc': 'የቀዝቃዛው ጦርነት ፍጥጫ፣ የገለልተኛ ሀገራት ንቅናቄ፣ የሶቪየት ህብረት ውድቀት፣ የፖላር አለም ስርአት እና ግሎባላይዜሽን።',
            },
            {
              'id': 'hist_u8',
              'grade': 12,
              'enUnit': 'Unit 8: Global Issues and Challenges',
              'amUnit': 'ክፍል 8: አለም አቀፍ ጉዳዮች እና ተግዳሮቶች',
              'enDesc': 'Climate change, environmental degradation, international terrorism, pandemics, migration, and international diplomacy.',
              'amDesc': 'የአየር ንብረት ለውጥ፣ የአካባቢ መራቆት፣ አለም አቀፍ ሽብርተኝነት፣ ወረርሽኞች፣ ስደት እና አለም አቀፍ ዲፕሎማሲ።',
            },
            {
              'id': 'hist_u9',
              'grade': 12,
              'enUnit': 'Unit 9: Contemporary World History',
              'amUnit': 'ክፍል 9: ወቅታዊ የአለም ታሪክ',
              'enDesc': 'Information revolution, rise of emerging global powers, digital age challenges, UN Sustainable Development Goals, and future prospects.',
              'amDesc': 'የኢንፎርሜሽን አብዮት፣ የታዳጊ ሀያላን ሀገራት መነሳት፣ የዲጂታል ዘመን ተግዳሮቶች፣ የተመድ ዘላቂ የልማት ግቦች እና የወደፊት ተስፋዎች።',
            },
          ];
        }
        return [
          ...
          return [
            {
              'id': 'econ_u1',
              'grade': 12,
              'enUnit': 'Unit 1: Introduction to Macroeconomics',
              'amUnit': 'ክፍል 1: የማክሮ ኢኮኖሚክስ መግቢያ',
              'enDesc': 'Scope and methodology of macroeconomics, aggregate demand and aggregate supply, business cycles, and macroeconomic goals.',
              'amDesc': 'የማክሮ ኢኮኖሚክስ ወሰንና ዘዴዎች፣ አጠቃላይ ፍላጎትና አቅርቦት፣ የንግድ ዑደቶች እና የማክሮ ኢኮኖሚ ግቦች።',
            },
            {
              'id': 'econ_u2',
              'grade': 12,
              ...
              'enDesc': 'Concepts of GDP, GNP, NNP, measurement approaches (output, income, expenditure), nominal vs real GDP, and price indexes.',
              'amDesc': 'የጂዲፒ፣ ጂኤንፒ፣ ኤንኤንፒ ጽንሰ-ሀሳቦች፣ የመለኪያ ዘዴዎች (ምርት፣ ገቢ፣ ወጪ)፣ ኖሚናል እና እውነተኛ ጂዲፒ።',
            },
            {
              'id': 'econ_u3',
              'grade': 12,
              ...
              'enDesc': 'Evolution and functions of money, money supply measures, commercial banking and credit creation, central banking roles.',
              'amDesc': 'የገንዘብ አመጣጥና ተግባራት፣ የገንዘብ አቅርቦት መለኪያዎች፣ የንግድ ባንኮች እና የብድር ፈጠራ፣ የማዕከላዊ ባንክ ሚና።',
            },
            {
              'id': 'econ_u4',
              'grade': 12,
              ...
              'enDesc': 'Causes, types, and economic consequences of inflation, types of unemployment, Okun’s law, and Phillips curve.',
              'amDesc': 'የዋጋ ንረት መንስኤዎች፣ አይነቶች እና ኢኮኖሚያዊ መዘዞች፣ የስራ አጥነት አይነቶች፣ የኦኩን ህግ እና የፊሊፕስ ከርቭ።',
            },
            {
              'id': 'econ_u5',
              'grade': 12,
              ...
              'enDesc': 'Government budget, taxation types, fiscal policy tools, monetary policy instruments, stabilization policies, and debt.',
              'amDesc': 'የመንግስት በጀት፣ የታክስ አይነቶች፣ የፊስካል ፖሊሲ መሳሪያዎች፣ የገንዘብ ፖሊሲ ስልቶች እና የማረጋጊያ ፖሊሲዎች።',
            },
            {
              'id': 'econ_u6',
              'grade': 12,
              ...
              'enDesc': 'Absolute and comparative advantage, gains from trade, trade protectionism (tariffs, quotas), balance of payments, and exchange rates.',
              'amDesc': 'ፍፁም እና አንጻራዊ ብልጫ፣ የንግድ ጥቅሞች፣ የንግድ ጥበቃ (ታሪፍ፣ ኮታ)፣ የክፍያ ሚዛን እና የምንዛሬ ተመን።',
            },
            {
              'id': 'econ_u7',
              'grade': 12,
              ...
              'enDesc': 'Growth vs development, human development index (HDI), poverty alleviation strategies, Millennium and Sustainable Development Goals.',
              'amDesc': 'እድገት እና ልማት፣ የሰው ልጅ ልማት መረጃ ጠቋሚ (HDI)፣ የድህነት ቅነሳ ስልቶች እና ዘላቂ የልማት ግቦች።',
            },
            {
              'id': 'econ_u8',
              'grade': 12,
              ...
              'enDesc': 'Structure of the Ethiopian economy, agriculture, industry, service sector, macroeconomic reforms, opportunities, and challenges.',
              'amDesc': 'የኢትዮጵያ ኢኮኖሚ መዋቅር፣ ግብርና፣ ኢንዱስትሪ፣ የአገልግሎት ዘርፍ፣ የማክሮ ኢኮኖሚ ማሻሻያዎች እና ተግዳሮቶች።',
            },
          ];
        }
        return [
